...
const RSVPSection = () => {
  ...
  const handleWhatsapp = () => {
    const phone = "523331187281"; // Tu número aquí
    const message = encodeURIComponent("¡Hola! Quiero confirmar mi asistencia al bautizo de Romina Sofía");
      ...
      >
        <div className="rsvp-card">
          ...
          <p className="rsvp-text">
            ...
            antes del<br></br> <strong>30 DE ABRIL</strong> para esperarte con mucha alegría.
          </p>
